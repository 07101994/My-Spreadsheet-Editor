...
namespace MySpreadsheetEditor.Behavior
{
    class ImportBehavior : Behavior<SfSpreadsheet>
    {
        ...
        void AssociatedObject_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            try
            {
                using (var fileStream = new FileStream(string.IsNullOrWhiteSpace(window.FilePath) ? @"Data\GettingStarted.xlsx" : window.FilePath, FileMode.Open))
                {
